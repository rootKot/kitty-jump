...
export namespace Images {
    ...
    export class ImagesLoadingBackground {
        static getName(): string { return 'loadingBackground'; }

        static getPNG(): string { return require('assets/images/loadingBackground.png'); }
    }
...
export namespace Spritesheets {
    ...
    export class SpritesPlayer140210 {
        ...
        static getPNG(): string { return require('assets/sprites/player.[140,210].png'); }
        static getFrameWidth(): number { return 140; }
        static getFrameHeight(): number { return 210; }
        static getFrameMax(): number { return -1; }
        static getMargin(): number { return 0; }
        static getSpacing(): number { return 0; }
    }
